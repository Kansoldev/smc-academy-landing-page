    ...
    <section className="w-full bg-[#f5f6f8] text-[#12141a] py-14 px-6">
      <div className="max-w-290 mx-auto grid md:grid-cols-2 items-center gap-10 px-5 md:px-0">
        <div>
          ...
          <p className="max-w-md text-[#12141a] text-lg mb-5">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-3 text-[#12141a]">
              <Calendar size={18} className="text-[#12141a] shrink-0" />
              <span>Mon 7th – Wed 9th September, 2026</span>
            </div>

            <div className="flex items-center gap-3 text-[#12141a]">
              <Clock size={18} className="text-[#12141a] shrink-0" />
              <span>1pm each day</span>
            </div>

            <div className="flex items-center gap-3 text-[#12141a]">
              <MapPin size={18} className="text-[#12141a] shrink-0" />
              <span>
            ...
            <div className="flex items-center gap-3 text-[#12141a]">
              <Video size={18} className="text-[#12141a] shrink-0" />
              <span>Also available live on Zoom</span>
            </div>

            <div className="flex items-center gap-3 text-[#12141a]">
              <Phone size={18} className="text-[#12141a] shrink-0" />
              <span>+234 802 496 9563, +234 903 204 4444</span>
            </div>

            <div className="flex items-center gap-3 text-[#12141a]">
              <Mail size={18} className="text-[#12141a] shrink-0" />
              <a
